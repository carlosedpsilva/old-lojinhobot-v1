...
public class WarnCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
       ...
       // logChannel.sendMessage("Warn enviado para: " + target.getAsMention() + "\n Conteudo: "+ reason ).queue();  
        ...
        eb.setTitle("Voce recebeu um aviso:")
            .setColor(Color.orange)
            .setDescription(reason)
            .setImage("https://scontent-atl3-1.cdninstagram.com/v/t51.2885-15/e35/c10.0.300.300a/117671453_736111576978517_4063377491529020764_n.jpg?_nc_ht=scontent-atl3-1.cdninstagram.com&_nc_cat=105&_nc_ohc=FZjZ3LJeKWAAX_gJCPz&oh=02ab01882c97d8c9ab6386e0c27e1b5a&oe=5F67DD61");
    ...
    public String getHelp() {
        return "envia uma mensagem de aviso ao usuario marcado"
